...
var Puzzler = function(imageSrc, type, jigsaws, onComplete, onProgress, debugMode) {
    ...
    function makePiece(x, y, pieceWidth, pieceHeight) {
        ...
        if (pieceRelation[0] !== null && pieceRelation[0].jigsaw) {
        ...
        if (pieceRelation[1] !== null && pieceRelation[1].jigsaw) {
        ...
        if (pieceRelation[2] !== null && pieceRelation[2].jigsaw) {
        ...
        if (pieceRelation[3] !== null && pieceRelation[3].jigsaw) {
        ...
        if (hasJigsaw(pieceRelation[1]) && pieceRelation[1].jigsaw) {
            cutter = pieceRelation[1].jigsaw;
        ...
        if (hasJigsaw(pieceRelation[2]) && pieceRelation[2].jigsaw) {
            cutter = pieceRelation[2].jigsaw;
